...
function submitDonNhap(event) {
    ...
    // let ngayNhap = document.getElementById("donNhap_ngayNhap").value;
    var ngayNhap = document.getElementById("donNhap_ngayNhap").value;
    const soLuong = document.getElementById("donNhap_soLuong").value;
    const tongTien = document.getElementById("donNhap_tongTien").value;
    // if (ngayNhap.includes("/")) {
    //     ngayNhap = convertDMYtoISO(ngayNhap);
    // }
    fetch("/hanghoa/nhap", {
        method: "POST",
