...
@Query(value = "SELECT " +
               ...
               ") AS d " +
               "WHERE d.Ngay BETWEEN :fromDate AND :toDate " + // Sử dụng tham số được đặt tên
               "ORDER BY d.Ngay",
       nativeQuery = true)
List<Object[]> getDoanhThuChiTieuTheoNgay(@Param("fromDate") Date fromDate, @Param("toDate") Date toDate);
