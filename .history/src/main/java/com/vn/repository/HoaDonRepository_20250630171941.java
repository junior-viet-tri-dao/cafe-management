...
public interface HoaDonRepository extends JpaRepository<HoaDon, Integer> {
    ...
    "WHERE hd.ngay_gio_tao >= '2025-01-03' " +
    "  AND hd.ngay_gio_tao <  '2025-01-07' " +
    "  AND hd.trang_thai =  '1' " +
    "ORDER BY hd.ngay_gio_tao DESC",
        nativeQuery = true)
    List<Object[]> getHoaDonByDateRangeAndStatus(@Param("fromDate") Date fromDate, @Param("toDate") Date toDate, Pageable pageable);
}
