...
public class ChiTieuController {
    ...
    public String createTable(@Valid @ModelAttribute("chiTieu") ChiTieu chiTieu, BindingResult result, Model model,RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("successMessage", "Thêm mới chi tiêu thành công");
