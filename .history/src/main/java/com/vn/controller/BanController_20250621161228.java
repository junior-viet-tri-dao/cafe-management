...
public Object danhSachBanRanh(@RequestParam Integer maBanCu) {
    ...
    public Object layThucDonTheoBan(@PathVariable Integer maBan) {
        ...
        List<com.vn.model.ThucDon> thucDonList = thucDonRepository.findAll();
        // List<Map<String, Object>> thucDonData = thucDonList.stream().map(td -> java.util.Map.of(
        //     "maThucDon", td.getMaThucDon(),
        //     "tenMon", td.getTenMon(),
        //     "giaTienHienTai", td.getGiaTienHienTai()
        // )).collect(java.util.stream.Collectors.toList());
