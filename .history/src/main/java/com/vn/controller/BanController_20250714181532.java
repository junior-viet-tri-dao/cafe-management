...
public class BanController {
    ...
    public String createTable(@Valid @ModelAttribute("table") Ban table, BindingResult result, Model model,RedirectAttributes redirectAttributes) {
        if(banRepository.existsByMaBan(table.getMaBan())) {
            result.rejectValue("maBan", null, "Mã bàn đã tồn tại");
        }

        if (banRepository.existsByTenBan(table.getTenBan())) {
    ...
    public String listTable(@RequestParam(defaultValue = "0") int page,
                            ...
                            Model model) {
        Page<Ban> posts =  banRepository.searchBan(keyword, PageRequest.of(page, size));
    ...
    public String submitDatBan(
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("errorMessage", "Lỗi định dạng ngày giờ đặt vui lòng đặt lại");
            return "redirect:/admin/sales/table-list";
    ...
    if (ban.getTinhTrang() != null) {
        ...
        if (ban.getTinhTrang().name().equals("DaDat")) {
            ...
            return Map.of(
                ...
                "ngayGioDat", chiTiet.getNgayGioDat() != null ? new SimpleDateFormat("dd/MM/yyyy HH:mm").format(chiTiet.getNgayGioDat()) : "",
        ...
        .collect(Collectors.toList());
            ...
            return Map.of(
                ...
                "tenKhachHang", chiTiet.getTenKhachHang(),
                "sdtKhachHang", chiTiet.getSdtKhachHang(),
                "ngayGioDat", chiTiet.getNgayGioDat() != null ? new java.text.SimpleDateFormat("dd/MM/yyyy HH:mm").format(chiTiet.getNgayGioDat()) : "",
    ...
    public Object layThucDonTheoBan(@PathVariable Integer maBan) {
        ...
        if (tinhTrang == null || tinhTrang == TinhTrangBan.Ranh) {
            return Map.of("success", false, "message", "Có khách đâu mà đặt món!");
        }
...
// api gộp bàn 
    ...
    public Object getTachBanInfo(@PathVariable Integer maBan) {
        ...
        if (banNguon == null || banNguon.getTinhTrang() != TinhTrangBan.DangDung) {
            return Map.of("success", false, "message", "Chỉ tách được bàn đang sử dụng!");
        }
    ...
    public Object postTachBan(
        ...
        try {
            ...
            if (banNguon == null || banDich == null) {
                return Map.of("success", false, "message", "Không tìm thấy bàn nguồn hoặc bàn đích!");
            }
            HoaDon hoaDonNguonObj = hoaDonRepository.findById(hoaDonNguon).orElse(null);
            if (hoaDonNguonObj == null) {
                return Map.of("success", false, "message", "Không tìm thấy hóa đơn nguồn!");
            }
            ...
            if (ngayGioDat != null) {
                try {
                    ...
                    chiTietDatBan.setNgayGioDat(new Date());
                }
            } else {
                chiTietDatBan.setNgayGioDat(new Date());
            }
            ...
            double tongTien = 0;
            // Xử lý từng món tách
            for (Map<String, Object> mon : monList) {
                ...
                if (cthdNguon == null || cthdNguon.getSoLuong() < soLuongTach) {
                    return Map.of("success", false, "message", "Số lượng tách vượt quá số lượng hiện có!");
                }
