...
public class BanController {
    ...
    public String submitDatBan(
        ...
        Ban ban = banRepository.findById(maBan).orElse(null);
        Users nhanVien = null;
        // Nếu có UserRepository thì lấy Users theo maNhanVien
        // Nếu không có thì bỏ qua dòng này
        // nhanVien = userRepository.findById(maNhanVien).orElse(null);
        ...
        try {
            ...
            // Lưu vào ChiTietDatBan
            ChiTietDatBan chiTiet = new ChiTietDatBan();
            chiTiet.setBan(ban);
            chiTiet.setHoaDon(hoaDon);
            if (nhanVien != null) chiTiet.setNhanVien(nhanVien); // Nếu lấy được Users
            ...
            // Cập nhật lại ngày giờ đặt cho hóa đơn nếu muốn
