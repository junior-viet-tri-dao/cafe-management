...
public class ChiTieuController {
    ...
    public String listTable(@RequestParam(defaultValue = "0") int page,
        ...
        if (keyword != null && !keyword.isEmpty()) {
            posts = chiTieuRepository.findAll(PageRequest.of(page, size)); // TODO: thay bằng searchBan nếu có
        } else {
            posts = chiTieuRepository.findAll(PageRequest.of(page, size));
        }
        ...
        return "admin/thuchi/thietbi-list";
    }
