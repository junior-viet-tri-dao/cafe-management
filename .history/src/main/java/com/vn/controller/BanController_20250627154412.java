...
List<Map<String, Object>> thucDonData = thucDonList.stream().map(td -> {
    ...
    public Object getThanhToan(@PathVariable Integer maBan) {
        ...
        // Lấy ChiTietDatBan mới nhất cho bàn này
    ...
    public Object postThanhToan(@RequestParam Integer maBan, @RequestParam Integer maHoaDon, @RequestParam Double tongTien) {
        ...
        hoaDon.setTrangThai(true); // 1 = đã thanh toán
        hoaDonRepository.save(hoaDon);
        return Map.of("success", true, "message", "Thanh toán thành công!");
    }


    // GỘP BÀN - Bước 1: Lấy danh sách bàn đích (bàn trống + bàn nguồn)
    ...
    public Object xacNhanGopBan(@RequestParam("banNguon") String banNguonStr,
        ...
        try {
            ...
            HoaDon hoaDon = new HoaDon();
            hoaDon.setNgayGioTao(new java.util.Date());
            hoaDon.setTrangThai(false);
            hoaDon.setTongTien(tongTien);
            hoaDon = hoaDonRepository.save(hoaDon);
    ...
    public Object getTachBanInfo(@PathVariable Integer maBan) {
        ...
        if (hoaDonList.isEmpty()) {
            return java.util.Map.of("success", false, "message", "Không tìm thấy hóa đơn đang mở cho bàn này!");
        }
    ...
    public Object postTachBan(
        ...
        try {
            ...
            java.util.List<java.util.Map<String, Object>> monList = mapper.readValue(monListJson, java.util.List.class);
            // Tạo hóa đơn mới cho bàn đích
            ...
            com.vn.auth.CustomUserDetail userDetail = (com.vn.auth.CustomUserDetail) authentication.getPrincipal();
            com.vn.model.Users nhanVien = userRepository.findById(userDetail.getUsersDB().getMaNhanVien()).orElse(null);
            ...
            // Nếu bàn nguồn hết món thì chuyển trạng thái nếu cần
            ...
            return java.util.Map.of("success", true, "message", "Tách bàn thành công!");
        } catch (Exception e) {
            return java.util.Map.of("success", false, "message", "Lỗi xử lý: " + e.getMessage());
        }
    }
