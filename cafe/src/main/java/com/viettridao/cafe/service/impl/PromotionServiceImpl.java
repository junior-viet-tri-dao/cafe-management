...
public class PromotionServiceImpl implements PromotionService {
    ...
    /**
     * Lấy danh sách tất cả khuyến mãi chưa bị xóa.
     *
     * @param pageable Đối tượng phân trang.
     * @return Đối tượng PromotionPageResponse chứa thông tin tất cả khuyến mãi.
     */
    @Override
    public PromotionPageResponse getAllPromotions(Pageable pageable) {
        Page<PromotionEntity> pageData = promotionRepository.findByIsDeletedFalse(pageable);
