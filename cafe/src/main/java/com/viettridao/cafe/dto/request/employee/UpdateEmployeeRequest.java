...
public class UpdateEmployeeRequest {
    ...
    @NotNull(message = "ID nhân viên không được để trống khi cập nhật")
    ...
    // URL ảnh có thể trống nếu không có ảnh, hoặc là một URL hợp lệ
    // Nếu bạn muốn URL ảnh phải luôn hợp lệ khi được cung cấp, bỏ '|^$'
...
//    private Double salary;
    ...
    // @Pattern(regexp = "^[a-zA-Z0-9]+$", message = "Tên đăng nhập chỉ chứa chữ và số") // Tùy chọn
